...
//    NSString * filePath = [[NSBundle mainBundle] pathForResource:[NSString stringWithFormat:@"flip_%ld", (long)index] ofType:@"wav"];
//    NSData * data = [NSData dataWithContentsOfFile:filePath];
//    
//    AVAudioPlayer * audioPlayer = [[AVAudioPlayer alloc] initWithData:data error:nil];
//    
//    [audioPlayer prepareToPlay];//预加载缓存并获取音频硬件播放需求
//    
//    [audioPlayer play];
}
